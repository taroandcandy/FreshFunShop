    ...
    <scroll-view scroll-y class="viewport" id="scroller" @scrolltolower="onScrolltolower">
        <template v-if="order">
            ...
            <view class="overview" :style="{ paddingTop: safeAreaInsets.top + 20 + 'px' }">
                ...
                <template v-if="order.orderState === OrderState.DaiFuKuan">
                    ...
                    <view class="tips">
                        ...
                        <!-- 倒计时显示 -->
                        <uni-countdown :second="order.countdown" color="#fff" :show-day="false" :show-colon="false"
                            splitor-color="#fff" @timeup="onTimeUp" />
                    </view>
                ...
                <template v-else>
                    ...
                    <view class="button-group">
                        <navigator class="button" :url="`/pagesOrder/create/index?orderId=${query.id}`"
                            hover-class="none">
                            再次购买
                        </navigator>
            ...
            <view class="goods">
                <view class="item">
                    <navigator class="navigator" v-for="item in order.skus" :key="item.id"
                        :url="`/pages/goodsDetail/index?id=${item.spuId}`" hover-class="none">
            ...
            <view class="toolbar" :style="{ paddingBottom: safeAreaInsets?.bottom + 'px' }">
                ...
                <!-- 其他订单状态:按需展示按钮 -->
                <template v-else>
                    <navigator class="button secondary" :url="`/pagesOrder/create/index?orderId=${query.id}`"
                        hover-class="none">
                        再次购买
                    </navigator>
                    <!-- 待收货状态: 展示确认收货 -->
                    ...
                    <view class="button delete" v-if="order?.orderState >= OrderState.DaiPingJia" @tap="onDeleteOrder">
                        删除订单
                    </view>
                </template>
            </view>
...
const { safeArea, safeAreaInsets, statusBarHeight } = uni.getWindowInfo()
// 猜你喜欢
...
// 提价订单后倒计时30分钟等待支付，计时结束修改订单状态为已取消
const onTimeUp = () => {
