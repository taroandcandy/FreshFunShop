        ...
        <template v-if="memberStore.profile">
                ...
                <uni-swipe-action>
                    ...
                    <uni-swipe-action-item v-for="item in cartList" :key="item.skuId" class="cart-swipe">
                        ...
                        <view class="goods">
                            ...
                            <navigator :url="`/pages/goodsDetail/index?id=${item.id}`" hover-class="none"
                                class="navigator">
                            ...
                            <view class="cart-swipe-right">
                                <button class=" delete-button icon-delete" @tap="onDeleteItem(item.skuId)"></button>
                            </view>
                        </view>
                        <!-- 右侧删除按钮--样式有问题 -->
                        <!-- <template #right> -->
            ...
            <view class="toolbar" style="padding-bottom: env(safe-area-inset-bottom)">
                ...
                <view class="button-grounp">
                    <view class="button payment-button" :class="{ disabled: selectedCardCount === 0 }"
                        @tap="gotoPayment">
