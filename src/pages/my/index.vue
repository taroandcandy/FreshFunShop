    ...
    <scroll-view class="viewport" scroll-y enable-back-to-top @scrolltolower="onScrolltolower">
        ...
        <view class="profile" :style="{ paddingTop: safeAreaInsets!.top + 'px' }">
          ...
          -->
            ...
            <navigator class="settings" url="/pagesMember/mySettings/index" hover-class="none">
                设置
            </navigator>
            <!-- <button @tap="get">测试</button> -->
        </view>
        <!-- 我的订单 -->
        <view class="orders">
            <view class="title">
            ...
            <view class="section">
                <navigator v-for="item in orderTypes" :key="item.type" :class="item.icon"
                    :url="`/pagesOrder/list/index?type=${item.type}`" class="navigator" hover-class="none">
                    {{ item.text }}
                </navigator>
...
.viewport {
    ...
    background-image: url(https://apipc-xiaotuxian-front.itheima.net/miniapp/images/center_bg.png);
